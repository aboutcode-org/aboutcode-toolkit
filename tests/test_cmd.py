...
def test_report_errors_can_write_to_logfile():
    ...
    _ec = cmd.report_errors(errors, quiet=False, verbose=True, log_file_loc=result_file)
...
def test_about_inventory_help_text():
    check_about_stdout(
        ["inventory", "--help"], "test_cmd/help/about_inventory_help.txt", regen=False
    )


def test_about_gen_help_text():
    check_about_stdout(["gen", "--help"], "test_cmd/help/about_gen_help.txt", regen=False)


def test_about_gen_license_help_text():
    check_about_stdout(
        ["gen-license", "--help"], "test_cmd/help/about_gen_license_help.txt", regen=False
    )


def test_about_check_help_text():
    check_about_stdout(["check", "--help"], "test_cmd/help/about_check_help.txt", regen=False)


def test_about_attrib_help_text():
    check_about_stdout(["attrib", "--help"], "test_cmd/help/about_attrib_help.txt", regen=False)
...
def test_about_transform_help_text():
    check_about_stdout(
        ["transform", "--help"], "test_cmd/help/about_transform_help.txt", regen=False
    )


def test_about_transform_expanded_help_text():
    check_about_stdout(
        ["transform", "--help-format"], "test_cmd/help/about_transform_config_help.txt", regen=False
    )
