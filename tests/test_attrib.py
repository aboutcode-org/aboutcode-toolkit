...
class GenerateTest(unittest.TestCase):
    def test_generate_from_collected_inventory_wih_custom_temaplte(self):
        ...
        min_license_score = 0
        scancode = False
        error, result = attrib.generate(
            abouts, is_about_input, license_dict, scancode, min_license_score, template=template
        )
    ...
    def test_generate_with_default_template(self):
        ...
        error, result = attrib.generate_from_file(
            abouts, is_about_input, license_dict, scancode, min_license_score
        )
        assert not error
    ...
    def test_scancode_input_min_score_0(self):
        test_file = get_test_loc("test_attrib/scancode_input/sc-2-licenses.json")
        ...
        lic_dict, _lic_errors = model.pre_process_and_fetch_license_dict(abouts)
        errors, result = attrib.generate_from_file(
            abouts, is_about_input, lic_dict, scancode, min_license_score=0
        )
        assert not errors

        expected_file = get_test_loc("test_attrib/scancode_input/sc-min_score-0.html")
        with open(expected_file) as exp:
            expected = exp.read()
    ...
    def test_scancode_input_min_score_100(self):
        ...
        expected_file = get_test_loc("test_attrib/scancode_input/sc.html")
        with open(expected_file) as exp:
            expected = exp.read()
    ...
    def test_scancode_input_dup_lic(self):
        ...
        expected_file = get_test_loc("test_attrib/scancode_input/sc-dup-lic.html")
        with open(expected_file) as exp:
            expected = exp.read()
    ...
    def test_scancode_input_dup_lic_match(self):
        test_file = get_test_loc("test_attrib/scancode_input/sc-dup-lic-match.json")
        errors, abouts = gen.load_inventory(test_file, scancode=True)
        print("############################")
        print(errors)
        # Check if there is error's level > INFO
        ...
        expected_file = get_test_loc("test_attrib/scancode_input/sc-dup-lic-match.html")
        with open(expected_file) as exp:
            expected = exp.read()
    ...
    def test_scancode_input_multi_lic(self):
        test_file = get_test_loc("test_attrib/scancode_input/sc-multi-lic.json")
        errors, abouts = gen.load_inventory(test_file, scancode=True)
        # Check if there is error's level > INFO
        result = [(level, e) for level, e in errors if level > INFO]
        assert result == []
        ...
        expected_file = get_test_loc("test_attrib/scancode_input/sc-multi-lic.html")
        with open(expected_file) as exp:
            expected = exp.read()
    ...
    def test_generate_with_csv(self):
        ...
        expected_file = get_test_loc("test_attrib/default_template/expect.html")
        with open(expected_file) as exp:
            expected = exp.read()
